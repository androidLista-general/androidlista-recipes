...
default[:apache][:contact] = 'cfernandez@hispagatos.org'
...
# Prefork Attributes
default[:apache][:prefork][:startservers] = 24
default[:apache][:prefork][:minspareservers] = 24
default[:apache][:prefork][:maxspareservers] = 162
default[:apache][:prefork][:serverlimit] = 600
default[:apache][:prefork][:maxclients] = 600
...
default[:apache][:worker][:maxsparethreads] = 264
